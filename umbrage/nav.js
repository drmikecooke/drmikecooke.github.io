var menuItems = {'Interpolation': [['interpolation/0.html', '0 — Lagrange polynomials']], 'Shift operations': [['shift/0.html', '0 — Introduction']], 'Difference operators': [['differences/0.html', '0 — Intro'], ['differences/1.html', '1 — Backward'], ['differences/2.html', '2 — Forward'], ['differences/3.html', '3 — Central']], 'Central difference operator': [['central/0.html', '0 — Start']], 'Convolution type': [['convoluted/0.html', '0 — Convolution and binomial type'], ['convoluted/1.html', '1 — Interlude'], ['convoluted/2.html', '2 — Generating functions']], 'Delta force': [['delta/0.html', '0 — Introduction'], ['delta/1.html', '1 — Basic training'], ['delta/2.html', '2 — Expansions']]}
...
function details(title,list){
  ...
  for (var item of list)element.innerHTML+=anchor('/umbrage/'+item[0],item[1])
  return element
}
