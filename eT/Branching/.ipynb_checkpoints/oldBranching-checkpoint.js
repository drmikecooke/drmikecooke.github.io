function tree() {
  ...
  svgtxt += svgText(-20,350,"black","end",30,"Generations: ");
	svgtxt += svgText(-20,400,"black","end",30,"Nodes: ");
...
function svgGLine(xv,n,c) {
	return svgLine(xv,0,xv,300,"black",1) + svgText(xv,350,"black","middle",30,n.toString()) + svgText(xv,400,"black","middle",30,c.toString())
}
